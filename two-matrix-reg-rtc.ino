...
void Display() {
  ...
  byte two0[8] = {0x28,0x00,0x86,0x89,0xf2,0x00,0x00,0x00};
  byte three0[8] = {0x24,0x00,0x7e,0x89,0x4a,0x00,0x00,0x00};
  ...
  byte one1[8] = {0x00,0x00,0xff,0x02,0x00,0x00,0x00,0x00};
  byte two1[8] = {0x00,0x00,0x86,0x89,0xf2,0x00,0x00,0x00};
  byte three1[8] = {0x00,0x00,0x7e,0x89,0x4a,0x00,0x00,0x00};
  byte four1[8] = {0x00,0x00,0xfc,0x08,0x0f,0x00,0x00,0x00};
  byte five1[8] = {0x00,0x00,0x71,0x89,0x4f,0x00,0x00,0x00};
  byte six1[8] = {0x00,0x00,0x72,0x89,0x7e,0x00,0x00,0x00};
  byte seven1[8] = {0x00,0x00,0x07,0xf9,0x01,0x00,0x00,0x00};
  byte eight1[8] = {0x00,0x00,0x76,0x89,0x76,0x00,0x00,0x00};
  byte nine1[8] = {0x00,0x00,0x7e,0x89,0x46,0x00,0x00,0x00};
  byte ten1[8] = {0x00,0x00,0x7e,0x81,0x7e,0x00,0xff,0x02};
  byte eleven1[8] = {0x00,0x00,0xff,0x02,0x00,0x00,0xff,0x02};
  byte twelve1[8] = {0x00,0x00,0x86,0x89,0xf2,0x00,0xff,0x02};
  ...
  byte three2[8] = {0x7e,0x89,0x4a,0x00,0x7e,0x81,0x7e,0x00}; //03
  ...
  byte thirteen2[8] = {0x7e,0x89,0x4a,0x00,0xff,0x02,0x00,0x00}; //13
  ...
  byte twentythree2[8] = {0x7e,0x89,0x4a,0x00,0x86,0x89,0xf2,0x00}; //23
  ...
  // 30-39
  byte thirty2[8] = {0x7e,0x81,0x7e,0x00,0x7e,0x89,0x4a,0x00}; //30
  byte thirtyone2[8] = {0xff,0x02,0x00,0x00,0x7e,0x89,0x4a,0x00}; //31
  byte thirtytwo2[8] = {0x86,0x89,0xf2,0x00,0x7e,0x89,0x4a,0x00}; //32
  byte thirtythree2[8] = {0x7e,0x89,0x4a,0x00,0x7e,0x89,0x4a,0x00}; //33
  byte thirtyfour2[8] = {0xfc,0x08,0x0f,0x00,0x7e,0x89,0x4a,0x00}; //34
  byte thirtyfive2[8] = {0x71,0x89,0x4f,0x00,0x7e,0x89,0x4a,0x00}; //35
  byte thirtysix2[8] = {0x72,0x89,0x7e,0x00,0x7e,0x89,0x4a,0x00}; //36
  byte thirtyseven2[8] = {0x07,0xf9,0x01,0x00,0x7e,0x89,0x4a,0x00}; //37
  byte thirtyeight2[8] = {0x76,0x89,0x76,0x00,0x7e,0x89,0x4a,0x00}; //38
  byte thirtynine2[8] = {0x7e,0x89,0x46,0x00,0x7e,0x89,0x4a,0x00}; //39
  ...
  byte fortythree2[8] = {0x7e,0x89,0x4a,0x00,0xfc,0x08,0x0f,0x00}; //43
  ...
  byte fiftythree2[8] = {0x7e,0x89,0x4a,0x00,0x71,0x89,0x4f,0x00}; //53
